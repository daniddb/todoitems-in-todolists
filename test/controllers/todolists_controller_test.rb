...
class TodolistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post todolists_url, params: { todolist: { list_due: @todolist.list_due, list_name: @todolist.list_name } }
    end
  ...
  test "should update todolist" do
    patch todolist_url(@todolist), params: { todolist: { list_due: @todolist.list_due, list_name: @todolist.list_name } }
