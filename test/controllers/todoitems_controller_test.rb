...
class TodoitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todoitem" do
    assert_difference('Todoitem.count') do
      post todoitems_url, params: { todoitem: { completed: @todoitem.completed, description: @todoitem.description, item_due: @todoitem.item_due } }
    end
  ...
  test "should update todoitem" do
    patch todoitem_url(@todoitem), params: { todoitem: { completed: @todoitem.completed, description: @todoitem.description, item_due: @todoitem.item_due } }
